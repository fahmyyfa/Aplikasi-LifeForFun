...
Clean Architecture: Struktur folder yang terorganisir per fitur untuk kemudahan pemeliharaan kode.

Safe Data Handling: Menggunakan null safety dan penanganan error untuk mencegah aplikasi crash saat data kosong.

Localization: Dukungan format mata uang Rupiah dan tanggal Indonesia menggunakan paket intl.
